...
const popupV3 = options => {
    ...
    const dialog_html = '<div class="dialog-container">' + '<div class="dialog-content">' + '<div class="dialog-header">' + '<h5 class="dialog-title"></h5>' + '<button type="button" class="close" data-dismiss="dialog" aria-label="Close">&times;</button>' + "</div>" + '<div class="dialog-body"></div>' + '<div class="dialog-footer"></div>' + "</div>" + "</div>";
